...
class OnboardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        slides = [
                    ...
                    OnboardingSlide(title: "Instant World-Wide Delivery", description: "Your orders will be delivered instantly irrespective of your location around the world.", image: #imageLiteral(resourceName: "Delivery Boy"))
        ]
